...
int Catalogue::findBookInCatalogue(std::string key)
{
...
void Catalogue::printBooks()
{
	...
	for (int i = 0; i < currentIndex; ++i)
	{
		...
		cout << i << ":" << endl;
		cout << "Title: " << this->books[i].getData()[0] << endl;
		cout << "Author: " << this->books[i].getData()[1] << endl;
		cout << "Year: " << this->books[i].getData()[2] << endl << endl;
