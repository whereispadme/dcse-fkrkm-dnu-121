...
QT_MOC_LITERAL(10, 20), // "sendSignalToListForm"
QT_MOC_LITERAL(31, 0), // ""
QT_MOC_LITERAL(32, 24), // "std::vector<std::string>"
QT_MOC_LITERAL(57, 23), // "on_lineEdit_textChanged"
QT_MOC_LITERAL(81, 4), // "arg1"
QT_MOC_LITERAL(86, 21) // "on_pushButton_clicked"

    },
    "InputForm\0sendSignalToListForm\0\0"
...
void InputForm::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->sendSignalToListForm((*reinterpret_cast< std::add_pointer_t<std::vector<std::string>>>(_a[1]))); break;
        ...
        {
            using _t = void (InputForm::*)(std::vector<std::string> );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&InputForm::sendSignalToListForm)) {
                *result = 0;
                return;
            }
        }
...
, QtPrivate::TypeAndForceComplete<InputForm, std::true_type>, QtPrivate::TypeAndForceComplete<void, std::false_type>, QtPrivate::TypeAndForceComplete<std::vector<std::string>, std::false_type>
...
// SIGNAL 0
void InputForm::sendSignalToListForm(std::vector<std::string> _t1)
{
